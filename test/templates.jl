...
@testset "CosineRing" begin
    t = CosineRing(
        0.1, (0.1, 0.2, 0.3), (0.0, 0.25, 1.5), (0.5, 0.1, 0.2),
        (0.0, -0.25, -2.0)
    )
    test_template(t)
    ...
    tr = CosineRing(
        5.0, 1.0, (0.1, 0.2, 0.3), (0.0, 0.25, 1.5), (0.5, 0.1, 0.2),
