...
# """
# struct StokesIntensityMap{T,N,SI<:AbstractArray{T,N},SQ<:AbstractArray{T,N},
#                           SU<:AbstractArray{T,N},SV<:AbstractArray{T,N},
#                           G<:AbstractRectiGrid}
#     """
#     Stokes I image
#     """
...
# function StokesIntensityMap(I::IntensityMap{T,N},
#                             Q::IntensityMap{T,N},
#                             U::IntensityMap{T,N},
...
#     return StokesIntensityMap(stokes(img, :I), stokes(img, :Q), stokes(img, :U),
#                               stokes(img, :V))
# end
...
# Base.@propagate_inbounds Base.getindex(im::StokesIntensityMap, i::Int) = StokesParams(getindex(im.I,
#                                                                                                i),
#                                                                                       getindex(im.Q,
#                                                                                                i),
#                                                                                       getindex(im.U,
...
#                                                                                       getindex(im.V,
#                                                                                                i))
# Base.@propagate_inbounds Base.getindex(im::StokesIntensityMap, I...) = StokesParams.(getindex(im.I,
#                                                                                               I...),
#                                                                                      getindex(im.Q,
#                                                                                               I...),
#                                                                                      getindex(im.U,
...
# function ComradeBase.flux(img::StokesIntensityMap{T}) where {T}
#     return StokesParams(flux(stokes(img, :I)),
#                         flux(stokes(img, :Q)),
#                         flux(stokes(img, :U)),
#                         flux(stokes(img, :V)))
# end
