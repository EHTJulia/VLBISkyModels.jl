...
EnzymeRules.inactive_type(::Type{<:NUFTPlan}) = true
EnzymeRules.inactive_type(::Type{<:NFFTPlan}) = true
...
@inline function _nuft(p::NUFTPlan{<:FourierTransform,<:AbstractVector},
